...
**Summary / 摘要**: 2026-03-21 共 4 次计划、0 次成交、0 次换汇记录，对账权益 HKD 4,701.56，对账累计盈亏 HKD -298.44，对账未实现盈亏 HKD -97.50。
...
| Benchmarks / 基准快照 | 15 |
| Latest Decision / 最新决策 | [US] HOLD 无 |
| End Equity / 结束权益 | HKD 4,701.56 |
| End Net PnL / 结束累计盈亏 | HKD -298.44 |
| End Unrealized PnL / 结束未实现盈亏 | HKD -97.50 |
| Trade Episodes / 交易片段 | 0 |
