...
**Summary / 摘要**: 2026-03-20 共 4 次计划、0 次成交、0 次换汇记录，对账权益 HKD 4,780.16，对账累计盈亏 HKD -219.84，对账未实现盈亏 HKD -18.91。
...
| Benchmarks / 基准快照 | 16 |
| Latest Decision / 最新决策 | [US] HOLD 无 |
| End Equity / 结束权益 | HKD 4,780.16 |
| End Net PnL / 结束累计盈亏 | HKD -219.84 |
