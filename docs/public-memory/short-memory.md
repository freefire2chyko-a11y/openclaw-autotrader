...
**Summary / 摘要**: 2026-03-14 共 22 次计划、0 次成交、0 次换汇记录，对账权益 HKD 4,891.03，对账累计盈亏 HKD -108.97，对账未实现盈亏 HKD -16.93。
...
| Benchmarks / 基准快照 | 19 |
| Latest Decision / 最新决策 | [US] HOLD 无 |
| End Equity / 结束权益 | HKD 4,891.03 |
| End Net PnL / 结束累计盈亏 | HKD -108.97 |
| End Unrealized PnL / 结束未实现盈亏 | HKD -16.93 |
| Trade Episodes / 交易片段 | 1 |

**Recent Trade Episodes / 最近交易片段**

- BUY SNDK | plan_only | edge=+1.46% | conf=0.60 | q=+0.00
