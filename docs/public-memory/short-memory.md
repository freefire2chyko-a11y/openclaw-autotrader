...
**Summary / 摘要**: 2026-03-13 共 2 次计划、0 次成交、0 次换汇记录，对账权益 HKD 4,879.40，对账累计盈亏 HKD -120.60，对账未实现盈亏 HKD -25.04。
...
| Benchmarks / 基准快照 | 9 |
| Latest Decision / 最新决策 | [US] HOLD 无 |
| End Equity / 结束权益 | HKD 4,879.40 |
| End Net PnL / 结束累计盈亏 | HKD -120.60 |
| End Unrealized PnL / 结束未实现盈亏 | HKD -25.04 |
| Trade Episodes / 交易片段 | 0 |
