...
| --- | --- | --- | --- | --- |
| `BABA` | 0.938 | HKD 991.23 | HKD -20.33 | Open / 持有中 |

## Latest Decision / 最新决策

- Market state / 市场状态: HK: 非交易时段 | US: 常规交易时段
- Decision time / 决策时间: 2026-03-14 01:54:07 CST (UTC+08:00)
- Decision / 决策结果: [US] HOLD / [US] 观望
- No-trade rationale / 观望理由: No US candidate cleared the live entry bar. The strongest name, `AAOI`, still showed score -0.19, post-fee EV -0.04%, and win probability 40.8%. / dry-run 本地快评估维持 HOLD。top candidates: AAOI:-0.19/-0.04% | SNDK:-0.33/-0.18% | MU:-0.43/-0.28%
