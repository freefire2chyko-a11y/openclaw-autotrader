...
Last synced by decision / 决策触发同步时间: `2026-03-21 01:16:22 CST`
...
| Current equity / 当前权益 | HKD 4,724.06 |
| Net PnL / 累计盈亏 | -HKD 275.94 |
...
- Updated / 更新时间: 2026-03-21 01:15:55 CST (UTC+08:00)
- Current book / 当前组合: `MU`
- Floating PnL / 当前浮动盈亏: -HKD 75.00
...
- Live pools today / 今日实盘池: US: `AVGO`, `NVDA`, `MU`, `AAPL` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `AVGO`, still showed score -6.93, post-fee EV -3.06%, and win probability 44.8%. / 研究链路未稳定返回，但当前最高候选 AVGO 的费后 EV 为 -3.06% ，仍低于 live 开仓门槛 3.27% ，按小账户费后纪律继续 HOLD。
