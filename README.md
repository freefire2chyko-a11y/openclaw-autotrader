...
Last synced by decision / 决策触发同步时间: `2026-03-19 06:11:21 CST`
...
| Current equity / 当前权益 | HKD 4,933.79 |
| Net PnL / 累计盈亏 | -HKD 66.21 |
...
- Updated / 更新时间: 2026-03-19 06:11:09 CST (UTC+08:00)
- Current book / 当前组合: `BABA`, `MU`
- Floating PnL / 当前浮动盈亏: +HKD 13.17
...
- Live pools today / 今日实盘池: US: `BABA`, `TSLA`, `ABBV`, `MA` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `BABA`, still showed score -2.58, post-fee EV -2.22%, and win probability 44.9%. / compare stage 已确认当前不值得开新风险，直接维持 HOLD。
