...
Last synced by decision / 决策触发同步时间: `2026-03-20 03:07:28 CST`
...
| Current equity / 当前权益 | HKD 4,793.04 |
| Net PnL / 累计盈亏 | -HKD 206.96 |
...
- Updated / 更新时间: 2026-03-20 03:06:48 CST (UTC+08:00)
- Current book / 当前组合: `MU`
- Floating PnL / 当前浮动盈亏: -HKD 6.02
...
- Live pools today / 今日实盘池: US: `AVGO`, `BABA`, `NVDA`, `GOOGL` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `QCOM`, still showed score -6.64, post-fee EV -2.77%, and win probability 54.4%. / 研究链路未稳定返回，但当前最高候选 QCOM 的费后 EV 为 -2.77% ，仍低于 live 开仓门槛 3.27% ，按小账户费后纪律继续 HOLD。
