...
Last synced by decision / 决策触发同步时间: `2026-03-19 02:28:11 CST`
...
| Current equity / 当前权益 | HKD 4,963.41 |
| Net PnL / 累计盈亏 | -HKD 36.59 |
...
- Updated / 更新时间: 2026-03-19 02:27:59 CST (UTC+08:00)
- Current book / 当前组合: `BABA`, `MU`
- Floating PnL / 当前浮动盈亏: +HKD 42.78
...
- Live pools today / 今日实盘池: US: `ABBV`, `AMD`, `TSLA`, `QCOM` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `AMD`, still showed score -2.68, post-fee EV -0.83%, and win probability 56.7%. / compare stage 已确认当前不值得开新风险，直接维持 HOLD。
