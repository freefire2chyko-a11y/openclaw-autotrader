...
Last synced by decision / 决策触发同步时间: `2026-03-20 03:19:24 CST`
...
| Current equity / 当前权益 | HKD 4,803.04 |
| Net PnL / 累计盈亏 | -HKD 196.96 |
...
- Updated / 更新时间: 2026-03-20 03:18:52 CST (UTC+08:00)
- Current book / 当前组合: `MU`
- Floating PnL / 当前浮动盈亏: +HKD 3.98
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `QCOM`, still showed score -6.33, post-fee EV -2.47%, and win probability 57.6%. / 所有候选标的费后EV均为负值（QCOM -2.47%、AVGO -1.81%、BABA -1.52%），远低于开仓门槛3.27%。高波动率市场环境下，事件层提示地缘政治与航运扰动风险。无符合费后纪律的新开仓机会。
