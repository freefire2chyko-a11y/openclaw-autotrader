...
Last synced by decision / 决策触发同步时间: `2026-03-16 23:17:17 CST`
...
| Current equity / 当前权益 | HKD 4,899.92 |
| Net PnL / 累计盈亏 | -HKD 100.08 |
...
- Updated / 更新时间: 2026-03-16 23:17:13 CST (UTC+08:00)
- Current book / 当前组合: `BABA`, `MU`
- Floating PnL / 当前浮动盈亏: -HKD 17.85
...
- Live pools today / 今日实盘池: US: `SNDK`, `EWY`, `LITE`, `MU` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `SNDK`, still showed score +2.66, post-fee EV +2.60%, and win probability 63.2%. / US 市场没有候选达到实盘门槛；最强标的 `SNDK` 仍只有评分 +2.66、扣费后 EV +2.60%、胜率 63.2%。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD / [US] 观望
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `SNDK`, still showed score +2.66, post-fee EV +2.60%, and win probability 63.2%. / US 市场没有候选达到实盘门槛；最强标的 `SNDK` 仍只有评分 +2.66、扣费后 EV +2.60%、胜率 63.2%。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `SNDK` (semiconductor) | score +2.66 | post-fee EV +2.60% | win 63.2%; `MU` (semiconductor) | score +2.28 | post-fee EV +1.23% | win 67.0%; `LITE` (optical networking) | score +1.00 | post-fee EV +0.90% | win 63.2%. / 共检查 5 只活跃候选。靠前检查结果：`SNDK`（半导体） | 评分 +2.66 | 扣费后 EV +2.60% | 胜率 63.2%；`MU`（半导体） | 评分 +2.28 | 扣费后 EV +1.23% | 胜率 67.0%；`LITE`（optical networking） | 评分 +1.00 | 扣费后 EV +0.90% | 胜率 63.2%。
