...
**🎯 Goal**: Turn 5,000 HKD into a profitable public case study / 目标：将 5,000 HKD 变成一个有盈利的公开案例
...
- Updated / 更新时间: 2026-03-14 14:56:59 CST (UTC+08:00)
- Current equity / 当前权益: HKD 0.00
- Net PnL / 累计盈亏: HKD -5,000.00
- Open positions / 当前持仓: 0
- Latest decision / 最新决策: N/A
- Latest decision time / 决策时间: N/A

### Quick Links / 快速链接

- [📊 Today's Monitor Card](./docs/public-monitor/2026/2026-03-14.md)
- [📝 Today's Daily Report](./docs/daily-reports/2026/2026-03-14.md)
- [🧠 Trading Memory](./docs/public-memory/README.md)
- [📅 Challenge Tracker](./docs/challenge-tracker.md)

---

## 🎯 What This Repo Publishes / 仓库公开内容

### Per-Day / 每日

1. **Public Monitor Card / 公开监控卡片**
   - Current holdings (sanitized) / 当前持仓（脱敏）
...
1. **Trading Memory / 交易记忆**
   - Short-term memory / 短期记忆
   - Long-term lessons / 长期教训

2. **Challenge Tracker / 挑战追踪**
   - Day-by-day progress / 逐日进度
   - Chapter highlights / 章节高光
...
| Feature | Description |
| --- | --- |
| 🧠 **Memory System** | Agent learns from its own trading patterns (short + long memory). |
| 🎯 **Risk Control** | Bounded 5,000 HKD pocket, no leverage, no short. |
| 🔄 **Auto Sync** | GitHub updates on every decision change. |
| 📊 **Public Dashboard** | Real-time stats in README. |
| 🌐 **Dual Market** | US primary, HK secondary monitoring. |
| 🤖 **Feishu Alerts** | Proactive notifications for all key events. |
...
If the challenge succeeds, this will become a complete public case study of automated trading.
如果你觉得这个项目有意思，不妨在 GitHub 上给它一个 ⭐！
如果挑战成功，这将是一个完整的自动交易公开案例研究。
...
**Last synced / 最后同步**: 2026-03-14 14:56:59 CST (UTC+08:00)
